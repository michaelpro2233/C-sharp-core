...
{
    static class FunWithMethods
    {
        public static void Main(string[] args)
        {
            /*
             None       If a parameter is not marked with a [arameter modifier, it is assumed to be passed by value,
        ...
        // Optional parameters must always be paccked onto the end of a method signature
